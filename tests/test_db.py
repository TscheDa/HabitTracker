...
def test_add_habit(test_repo):
    ...
    habit = Habit(name="Test Habit", periodicity=Periodicity.DAILY, created_at=datetime.now())
...
def test_add_duplicate_habit_error(test_repo):
    ...
    habit = Habit(name="Unique Habit", periodicity=Periodicity.DAILY, created_at=datetime.now())
...
def test_update_habit_name(test_repo):
    ...
    habit = Habit(name="Old Name", periodicity=Periodicity.DAILY, created_at=datetime.now())
    habit_id = test_repo.add_habit(habit)
...
def test_delete_habit(test_repo):
    ...
    habit = Habit(name="To Delete", periodicity=Periodicity.WEEKLY, created_at=datetime.now())
    habit_id = test_repo.add_habit(habit)
